package com.example.pizzajoe.ui.theme

import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFF124885) // фон кнопки и строка состояния, радио баттон
val md_theme_light_onPrimary = Color(0xFFFFFFFF) // цвет текста
val md_theme_light_primaryContainer = Color(0xC9E8A93C) // верхний бар
val md_theme_light_onPrimaryContainer = Color(0xB2E1C4B0) // фон заголовка
val md_theme_light_secondary = Color(0xA8FFE0BC) // фон пицц
val md_theme_light_onSecondary = Color(0xFF363333) // цвет разделителя
...
val md_theme_light_surface = Color(0x4DFFE0BC) //цвет для текста менее прозрачный
...
val md_theme_dark_onTertiaryContainer = Color(0xFFFDC8A5)
